# Open Math Problem Lists

A curated directory of open mathematics problem databases, subject-specific problem lists, formal conjecture repositories, and related research communities.

> Last verified: September 2, 2026  
> This directory collects public resources whose primary purpose is to list multiple research-level open problems. Inclusion does not endorse the current status of every problem. Always verify a problem against its original paper, the maintainer's notes, or a pinned repository revision before relying on it.

## General Databases and Directories
...
## Formalized and AI-Oriented Collections
...
| Name | Links | Scope |
| --- | --- | --- |
| Ben Green: 100 Open Problems | [PDF](https://people.maths.ox.ac.uk/greenbj/papers/open-problems.pdf) | One hundred problems in additive combinatorics, analytic number theory, arithmetic combinatorics, and related areas |
| OEIS Conjectures | [Conjectures](https://oeis.org/wiki/Conjectures) · [Open problems](https://oeis.org/wiki/Open_problems) · [Prime conjectures](https://oeis.org/wiki/List_of_prime_conjectures) | Integer sequences, number-theoretic conjectures, and related open questions |
| Problems in Graph Theory and Combinatorics | [Douglas West's list](https://dwest.web.illinois.edu/openp/index.html) | Graph theory, combinatorics, optimization, number theory, discrete geometry, and links to additional lists |
...
| Name | Links | Scope |
| --- | --- | --- |
| OpenTCS | [Website](https://opentcs.cc/) | Theoretical computer science problems in algorithms, complexity, graph algorithms, cryptography, automata, and related areas |
| TCS Open Problems | [Website](https://www.tcsopenproblems.com/) | Community collection organized by algorithms, complexity, quantum computing, error correction, graph theory, and other topics |
| cstheory Stack Exchange | [open-problem tag](https://cstheory.stackexchange.com/questions/tagged/open-problem) · [Source directory](https://cstheory.stackexchange.com/questions/38560/sources-of-open-problems) | Open-problem discussions and directories of subject-specific TCS lists |
| Open Problems in Sublinear Algorithms | [Wiki](https://sublinear.info/) · [Numbered list](https://sublinear.info/index.php?title=Open_Problems%3ABy_Number) | Streaming algorithms, property testing, communication complexity, and other sublinear algorithms |
| ORdős Problems | [Website](https://ordos-problems.github.io/) | Research-level problems in operations research, computer science, economics, and applied probability |
| Open Problems in Information Theory | [GitHub](https://github.com/gokhanmergen/information-theory-problems) | Structured information-theory collection recording attempts, partial results, and verification status |
| Open Quantum Problems | [Website](https://openquantumproblems.com/) · [GitHub](https://github.com/jpbruneton/open_quantum_problems) | Quantum information, mathematical physics, quantum complexity, open systems, and foundations |
| Wikipedia subject lists | [Computer science](https://en.wikipedia.org/wiki/List_of_unsolved_problems_in_computer_science) · [Information theory](https://en.wikipedia.org/wiki/List_of_unsolved_problems_in_information_theory) · [Fair division](https://en.wikipedia.org/wiki/List_of_unsolved_problems_in_fair_division) | Entry points for theoretical computer science, information theory, algorithmic game theory, and fair division |

## Classical Lists and Prize Problems

| List | Links | Scope |
| --- | --- | --- |
| Millennium Prize Problems | [Clay Mathematics Institute](https://www.claymath.org/millennium-problems/) | Official pages and prize rules for the seven Millennium Prize Problems |
| Hilbert's Problems | [MathWorld](https://mathworld.wolfram.com/HilbertsProblems.html) · [Status index](https://en.wikipedia.org/wiki/Hilbert%27s_problems) | Hilbert's 23 problems and the portions that remain unresolved |
| Smale's Problems | [Original paper](https://www.fim.uni-passau.de/fileadmin/dokumente/fakultaeten/fim/lehrstuhl/muller/SmaleProblems1998.pdf) · [MathWorld](https://mathworld.wolfram.com/SmalesProblems.html) | Stephen Smale's 18 major problems for the twenty-first century |
| Arnold's Problems | [Springer](https://link.springer.com/book/10.1007/b138219) · [Index](https://en.wikipedia.org/wiki/Arnold%27s_Problems) | V. I. Arnold's extensive cross-disciplinary collection with commentary |
| The Scottish Book | [History and index](https://en.wikipedia.org/wiki/Scottish_Book) | Classical research problems recorded by the Lwów School of Mathematics, some of which remain open |
| A New Kind of Science: Open Problems | [PDF](https://www.wolframscience.com/openproblems/NKSOpenProblems.pdf) | Open problems and projects involving computation, cellular automata, number theory, and discrete systems |

## Community and Discovery Sources
...
- Problem lists maintained by research institutions, subject editors, or original proposers generally provide stronger evidence than aggregators.
- Aggregated databases, Wikipedia, MathOverflow, and search pages are useful discovery tools but cannot by themselves establish that a problem remains open.
- AI-oriented platforms, machine-generated status reports, personal sites, and old wikis require additional verification.
- A Lean proof only establishes the encoded formal statement. The formalization must still be checked against the original mathematical problem.
- When a source marks a problem as solved or disproved, verify the paper, review status, expert confirmation, and exact scope of the result.

## Contributing

Issues and pull requests are welcome for new collections, broken links, and maintenance-status updates. Please include:

- the resource name and URL;
- the fields it covers;
- its maintainer or institution;
- its most recent update date; and
- whether it contains machine-generated material or unreviewed solution claims.
